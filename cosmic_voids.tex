...
\centering
  ...
  \captionof{figure}{\small Fractional Anisotropy  as a function of
    ...
    lines. V-Web, dashed lines). Thick central lines are the median
    and filled regions include $50\%$ of the cells in each bin. 
    The left panel we confirms that underdense regions can be
    ...
    threshold for the T-Web and V-web corresponding to that
    Fractional Anisotropy. 
    This threshold on the eigenvalues does not influence 
