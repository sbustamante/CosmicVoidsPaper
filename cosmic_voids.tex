...
\centering
  ...
  \includegraphics[trim = 1mm 0mm 5mm 10mm, clip, keepaspectratio=true,
  width=0.35\textheight]{FA_delta.pdf}
  \includegraphics[trim = 1mm 0mm 5mm 10mm, clip, keepaspectratio=true,
  width=0.35\textheight]{FA_environment.pdf}

  
  \captionof{figure}{\small Overdensity (upper left) and Fractional
    Anisotropy (upper right) with respect to the eigenvalue $\lambda_1$ 
    for each web scheme (T-Web, continous lines. V-Web, dashed lines) 
    calculated over all grid cells in the Bolshoi simulation. 
