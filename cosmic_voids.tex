...
This yields that the usually adopted definition of voids as underdense 
regions in the large-scale matter distribution, is not precise enough as 
it excludes a proper description of the internal structure of voids.
...
describing the structure of high non-linear regions (e.g. filaments, 
...
The attractiveness of this algorithm lies in it is parameter-free and does 
not require to make any assumption on the shape and morphology of voids. 
Although we just use a \textit{cloud-in-cell} (\texttt{CIC}) algorithm on 
a Cartesian mesh for estimating the density and tensor fields, instead of 
