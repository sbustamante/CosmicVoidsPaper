...
\centering
  ...
  catalogues. FA-T-web (continuous red curves), FA-Vweb (dashed blue 
  curves). Left panel, total distributions. Right panel, distributions of 
  subcompensanted and overcompensanted voids. }
...
We propose in this paper a new method to find and describe void in
cosmological dark matter simulations.
The basis of our metho is the anisotropy of the eigenvalues from tensors
constructed to describe the cosmic web. 
