...
%-------------------------------------------------------------------------
\subsection{FOF void finder}
\label{subsec:fof_finder}
%-------------------------------------------------------------------------
...
reduces percolation in cells. In Figure \ref{fig:percolation_analysis_FOF}
we show the obtained result of our percolation analysis for both web 
schemes. In both cases, it can be noticed that the volume of the largest 
void region is minimized at $\lambda_{th} = 0.0$, what means the 
percolation is completely reduced for this threshold value. However, 
according to our previous analysis, such value does not reproduce the
visual appearance of the cosmic web, so it is out of consideration. 
...
\centering
  ...
  width=0.25\textheight]{./figures/voids_regions_volume_FOF_null.pdf}
  \includegraphics[trim = 0mm 0mm 5mm 0mm, clip, keepaspectratio=true,
  width=0.25\textheight]{./figures/voids_regions_volume_FOF_opt.pdf}
