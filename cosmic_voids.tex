...
\after{In the left panel of Fig. \ref{fig:L1_correlations} we see how 
the FA correlates with the matter overdensity. 
A value of $\delta=-0.8$ corresponds to a value of $FA\sim 0.65$ regardless of
the web-finding scheme. 
