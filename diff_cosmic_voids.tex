...
%DIF 42a42-43
\newcommand{\before}[1]{\textcolor{red}{ #1}} %DIF > 
\newcommand{\after}[1]{\textcolor{darkgreen}{ #1}} %DIF > 
%DIF -------
...
\citep{Hoffman12}. 
Our procedure allows for a description of \DIFdelbegin \DIFdel{the internal structure
of voids that goes }\DIFdelend \DIFaddbegin \DIFadd{a void internal structure
}\DIFaddend beyond a simple definition of a void as an underdense region in the
...
cerebral tissue in nuclear magnetic resonance imaging\DIFdelbegin \DIFdel{and }\DIFdelend \DIFaddbegin \DIFadd{, thereby allowing to 
...
}\DIFaddend \citet{Libeskind13} introduced \DIFdelbegin \DIFdel{this concept }\DIFdelend \DIFaddbegin \DIFadd{the concept of the FA }\DIFaddend in the context of 
...
\begin{figure*}
  ...
  \caption{\DIFdelbeginFL \DIFdelFL{Visual impression of different }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Different }\DIFaddendFL fields in a slice of
    $1\hMpc$ width in the Bolshoi simulation. \DIFaddbeginFL \DIFaddFL{Top/bottom panels correspond
    to the T-Web/V-Web.      
    }\DIFaddendFL Fractional Anisotropy field (left); cosmic web classification
    (middle) \DIFaddbeginFL \DIFaddFL{for a given value of the threhold eigenvalue
    $\lambda_{\rm th}$ }\DIFaddendFL where voids are white, sheets are light gray,
    filaments are dark gray and knots are black; \DIFdelbeginFL \DIFdelFL{colored }\DIFdelendFL individual voids (right) found by 
    the a watershed algorithm on the Fractional Anisotropy field. \DIFdelbeginFL \DIFdelFL{Top/bottom corresponds to }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Colours
    in }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{T-Web/V-Web}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{right panel correspond with the effective radius of each void}\DIFaddendFL . }
  \label{fig:FA_field}
\end{figure*}
%.........................................................................
...
Usually, the threshold \DIFaddbegin \DIFadd{$\lambda_{th}$ }\DIFaddend is a free parameter that is
tuned to reproduce the visual appearence of the comic web. 
\DIFdelbegin \DIFdel{In this paper we take a different approach.
...
This threshold does not enter into }\DIFdelend \DIFaddbegin \DIFadd{However, in this paper this threshold does not play any role in }\DIFaddend our
computations.
\DIFdelbegin \DIFdel{We simply offer this estimate
as a }\DIFdelend \DIFaddbegin \DIFadd{In Figure \ref{fig:L1_correlations} we offer a threshold estimate
(from the FA=$0.95$ as a function of $\lambda_1$, this choice is
explained in the next section) only as a }\DIFaddend guide to readers familiar
with \DIFdelbegin \DIFdel{the
meaningof this threshold}\DIFdelend \DIFaddbegin \DIFadd{its meaning}\DIFaddend .  
...
%DIFDELCMD <   \includegraphics[trim = 2mm 2mm 5mm 10mm, clip, keepaspectratio=true,
%DIFDELCMD <   width=0.35\textheight]{delta_L1.pdf}  
%DIFDELCMD <   \includegraphics[trim = 2mm 2mm 5mm 10mm, clip, keepaspectratio=true,
%DIFDELCMD <   width=0.35\textheight]{FA_L1.pdf}
%DIFDELCMD < 

%DIFDELCMD <   
%DIFDELCMD <   \captionof{figure}{\small Overdensity (left) and Fractional
%DIFDELCMD <     Anisotropy (right) with respect to the eigenvalue $\lambda_1$ 
%DIFDELCMD <     for each web scheme (T-Web, continous lines. V-Web, dashed lines) calculated 
%DIFDELCMD <     over all grid cells in the Bolshoi simulation. 
%DIFDELCMD <     Thick central lines are the median and filled regions include
%DIFDELCMD <     $50\%$ of the cells in each bin.
%DIFDELCMD <     This information is necesary to define void boundaries in
%DIFDELCMD <     the watershed algorithm. 
%DIFDELCMD <     The vertical lines show the equivalent threshold values for the
%DIFDELCMD <     T-Web and V-web in order to have voids composed by cells with
%DIFDELCMD <     Fractional Anisotrop equal or less than $0.95$. 
%DIFDELCMD <    This threshold on the eigenvalues does not influence our
%DIFDELCMD <    computations. 
%DIFDELCMD <    We show it as a guide to readers familiar with the
%DIFDELCMD <    order of magnitude expectation for this threshold.}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[trim = 1mm 0mm 5mm 10mm, keepaspectratio=true,
  ...
  \captionof{figure}{
    ...
    eigenvalue $\lambda_1$ for each web scheme (T-Web,  continous
    ...
    The left panel shows the tigth correlation between FA and
    $\lambda_1$ in voids.
  ...
  \DIFaddendFL \label{fig:L1_correlations}
...
%DIF > -------------------------------------------------------------------------
%DIF > FIGURE 3: Histograms for each environment regarding the FA value
...
\DIFaddend The fractional anisotropy (FA), as developed by \citet{Basser95}, 
...
\DIFdelbegin \DIFdel{Here we present }\DIFdelend \DIFaddbegin \DIFadd{In this manner, barriers such as microtubules and cell membranes, that 
...
account, we present here }\DIFaddend the FA, much in the same way as \citet{Libeskind13}, 
to use it as a tracer of cosmic voids.

%DIF > !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
\DIFaddbegin 

\DIFaddend The FA is defined as follows
%.........................................................................
...
of Fig. 1) is traced by \DIFaddbegin \DIFadd{middle to }\DIFaddend high FA values.  
...
Voids are regions where \DIFdelbegin \DIFdel{$\lambda_3\leq\lambda_2\leq
\lambda_1\leq\lambda_{th}$}\DIFdelend \DIFaddbegin \DIFadd{$\lambda_3\leq\lambda_2\leq
\lambda_1\leq\lambda_{\rm th}$}\DIFaddend . 
...
As we increase/decrease the threshold value \DIFdelbegin \DIFdel{$\lambda_{th}$}\DIFdelend \DIFaddbegin \DIFadd{$\lambda_{\rm th}$}\DIFaddend , voids
...
are \DIFdelbegin \DIFdel{indeed closely }\DIFdelend correlated. 
The \DIFdelbegin \DIFdel{right }\DIFdelend \DIFaddbegin \DIFadd{left }\DIFaddend panel shows the correlation between \DIFaddbegin \DIFadd{the FA and }\DIFaddend $\lambda_1$
and \DIFaddbegin \DIFadd{the middle panel between the overdensity }\DIFaddend $\delta$ \DIFdelbegin \DIFdel{for
all the grid cells in the simulation while the }\DIFdelend \DIFaddbegin \DIFadd{and $\lambda_1$.
The }\DIFaddend right panel shows the correlation between \DIFdelbegin \DIFdel{$\lambda_1$ }\DIFdelend \DIFaddbegin \DIFadd{$\delta$ }\DIFaddend and the
FA. 
This shows that the  \DIFdelbegin \DIFdel{overdensity has a large }\DIFdelend \DIFaddbegin \DIFadd{density has a larger }\DIFaddend scatter at fixed
$\lambda_1$ \DIFaddbegin \DIFadd{than the FA, yet large and  small values of the density
remain still associated to low values of the FA}\DIFaddend . 


\DIFaddbegin \DIFadd{At this point, the eigenvalue $\lambda_1$ and the FA appear to be
...
\DIFaddend From Figs. \ref{fig:FA_field} and \ref{fig:L1_correlations} we
...
this FA level is a \DIFdelbegin \DIFdel{sensitive }\DIFdelend \DIFaddbegin \DIFadd{reasonable }\DIFaddend choice to define voids.
...
\citep{Schaap00}.
\DIFdelbegin \DIFdel{However, from the analysis of our results the choice of a fixed
Cartesian mesh does not induce spurious results, at least with
the mass resolution we have in the N-body simulation}\DIFdelend \DIFaddbegin \DIFadd{Nevertheless, in our case the average number of particles per cell
  ...
  noisy density field sampling}\DIFaddend .
...
$\delta = -0.8$ \citep{Platen07},  which means that\DIFdelbegin \DIFdel{any ridge between
two voids with overdensity below that value is removed to merge the respective voids }\DIFdelend \DIFaddbegin \DIFadd{, given two neighbouring 
voids, if the mean value of the density across their common boundary is 
below that threshold, the two voids are merged}\DIFaddend .
In our case we have to find a corresponding FA value
to define this threshold.


In \DIFaddbegin \DIFadd{the right panel of }\DIFaddend Fig. \ref{fig:L1_correlations} we \DIFdelbegin \DIFdel{find the correlations of
the eigenvalue $\lambda_1$ }\DIFdelend \DIFaddbegin \DIFadd{see how 
the FA correlates }\DIFaddend with the matter overdensity\DIFdelbegin \DIFdel{(left panel) and
the FA (right panel). 
We can use this information to find the equivalent FA threshold. 
From the left panel we see that an underdensity }\DIFdelend \DIFaddbegin \DIFadd{. 
A value }\DIFaddend of $\delta=-0.8$ corresponds to \DIFdelbegin \DIFdel{$\lambda_1=0.0$, }\DIFdelend \DIFaddbegin \DIFadd{a value of FA$\sim 0.65$
}\DIFaddend regardless of the web-finding scheme. 
\DIFdelbegin \DIFdel{From the second panel we have a very tight correlation of $\lambda_1$
with the FA, indicating that in turn $\lambda_1=0.0$ corresponds to a
FA=$0.65$ which }\DIFdelend \DIFaddbegin \DIFadd{This }\DIFaddend is the value \DIFdelbegin \DIFdel{that }\DIFdelend we choose to remove ridges \DIFaddbegin \DIFadd{between two watershed
voids}\DIFaddend . 
...
%.........................................................................
%DIF < FIGURE 3: volume functions
%DIF > FIGURE 4: volume functions
\begin{figure*}
\centering
  ...
  \DIFdelbeginFL %DIFDELCMD < \captionof{figure}{\small Left panel, void size distribution. Right
%DIFDELCMD <     panel, fraction of overcompensated/subcompensated ($C>1/C<1$)voids as a
%DIFDELCMD <     function of the effective radius. The continous (dashed)
%DIFDELCMD <     curves correspond to the T-Web (V-Web).
%DIFDELCMD <     The abundance for small ($r_{eff}<2.0\hMpc$) overcompensated voids
%DIFDELCMD <     shoots up in the V-Web scheme.
%DIFDELCMD <     We provide in the body of the paper two reasons for this behaviour.}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \captionof{figure}{\small Left panel, void size distribution. Right
  ...
  \DIFaddendFL \label{fig:volume_function}
...
\DIFdelbegin \DIFdel{Below that scale numerical resolution effects become important}\DIFdelend \DIFaddbegin \DIFadd{For smaller interpolation/smoothing scales the shot noise in
  the low density regions starts to be noticeable}\DIFaddend .
With that choice we find a void volume filling fraction $54.88\%$ and
$47.06\%$ for the FA-Vweb and the FA-Tweb, respectively.  
\DIFaddbegin \DIFadd{For larger smoothing scales ($>5\hMpc$) the density and shear fields
  ...
  }\citep{Forero09,Alonso2015}\DIFadd{.  
In this paper we limit ourselves to a smoothing scale $\sim 1$ }\hMpc\DIFadd{.  
}\DIFaddend 
...
that the largest voids in the V-Web have \DIFdelbegin \DIFdel{$r_{\rm eff}\sim 10$}\DIFdelend \DIFaddbegin \DIFadd{$\reff \sim 10$}\DIFaddend \hMpc,
while the T-Web scheme includes voids as large as \DIFdelbegin \DIFdel{$r_{\rm eff}\sim 15$}\DIFdelend \DIFaddbegin \DIFadd{$\reff \sim 15$}\DIFaddend \hMpc. 
...
%.........................................................................
%DIF < FIGURE 4: Density profile of voids for each defined scheme
%DIF > FIGURE 5: Density profile of voids for each defined scheme
\begin{figure*}
\centering
...
compensation  index \DIFdelbegin \DIFdel{$\mathcal{C}$.
}\DIFdelend \DIFaddbegin \DIFadd{$C$
}\DIFaddend It is defined as the mass of a void enclosed in a spherical volume of
radius $R$ and normalized by the mass of the same volume assuming
it is filled by matter with the mean background density.

\eq{compensation}
{\DIFdelbegin \DIFdel{\mathcal{C} }\DIFdelend \DIFaddbegin \DIFadd{C}\DIFaddend = \frac{M_v}{\overline{M}} = \frac{3}{2R^{3}} \int_0^{R} [\delta(r) + 1] r^2 dr}
...
This leads us to voids with \DIFdelbegin \DIFdel{$\mathcal{C}>1$ }\DIFdelend \DIFaddbegin \DIFadd{$C>1$ }\DIFaddend having more mass than expected, 
...
In the same fashion, voids with \DIFdelbegin \DIFdel{$\mathcal{C}<1$ }\DIFdelend \DIFaddbegin \DIFadd{$C<1$ }\DIFaddend constitute the family
...
\DIFaddbegin \DIFadd{Table \ref{tab:number_voids} lists the number of voids in 
...
all the way up to the \DIFdelbegin \DIFdel{effective }\DIFdelend radius where the average radial
density reaches \DIFdelbegin \DIFdel{the average value.
For }\DIFdelend \DIFaddbegin \DIFadd{zero.
In }\DIFaddend voids with sizes \DIFdelbegin \DIFdel{$r_{\rm eff}<8\hMpc$ }\DIFdelend \DIFaddbegin \DIFadd{$\reff <8\hMpc$ }\DIFaddend the outflow is always
...
internal profile \DIFdelbegin \DIFdel{$r_{\rm eff}<1$ }\DIFdelend \DIFaddbegin \DIFadd{$r/\reff <1$ }\DIFaddend and the external profile \DIFdelbegin \DIFdel{$r_{\rm
  eff}>1$}\DIFdelend \DIFaddbegin \DIFadd{$r/\reff >1$}\DIFaddend . 
Subcompensanted voids in the T-Web reach an asymptotic background
value of F=$0.8$ almost right at \DIFdelbegin \DIFdel{$r_{\rm eff}=2$}\DIFdelend \DIFaddbegin \DIFadd{$r/\reff =2$}\DIFaddend . 
For the V-Web the results are similar, albeit \DIFdelbegin \DIFdel{rather slowly with }\DIFdelend \DIFaddbegin \DIFadd{with a slower trend with
}\DIFaddend the effective radius. 
Overcompensated voids reach a maximum FA at the same effective radiuus
\DIFdelbegin \DIFdel{$r_{\rm eff}=1$ }\DIFdelend \DIFaddbegin \DIFadd{$r/\reff =1$ }\DIFaddend and decline to reach an asymptotic value of FA=$0.85$
at larger radii.
...
(\DIFdelbegin \DIFdel{$r_{\rm eff}=3$}\DIFdelend \DIFaddbegin \DIFadd{$r/\reff =3$}\DIFaddend ) and the radius of the FA \DIFdelbegin \DIFdel{ridge ($r_{\rm eff}=1$ }\DIFdelend \DIFaddbegin \DIFadd{maxima ($r/\reff =1$, most
manifest in the T-Web voids}\DIFaddend ) justifies in a more quantiative way the
qualitative argument we present in sub-section \ref{subsec:watershed}
to define void boundaries in our method.  
Namely that as we increase the void boundary \DIFaddbegin \DIFadd{moving away from the
center}\DIFaddend , we reach first middle density walls, before reaching high
density structures associated with high anisotropy.  
This \DIFdelbegin \DIFdel{makes the FA ridge }\DIFdelend \DIFaddbegin \DIFadd{implies that voids defined with the FA never present positive
overdensities, making the FA maximum }\DIFaddend a reasonable boundary for voids
compared to the traditional definition that puts the boundary at the
\DIFdelbegin \DIFdel{density ridge}\DIFdelend \DIFaddbegin \DIFadd{densityridge}\DIFaddend .     
...
\DIFdelbegin \DIFdel{$r/r_{\rm eff}\sim 1$ }\DIFdelend \DIFaddbegin \DIFadd{$r/\reff \sim 1$ }\DIFaddend and the subcompensated voids reach average
density around \DIFdelbegin \DIFdel{$r/r_{\rm eff}\sim 3$}\DIFdelend \DIFaddbegin \DIFadd{$r/\reff \sim 3$}\DIFaddend . 
...
The \DIFdelbegin \DIFdel{Fractional Anisotropy }\DIFdelend \DIFaddbegin \DIFadd{FA }\DIFaddend profiles also show remarkable similarities
...
$\sim 0.7-0.8$ at \DIFdelbegin \DIFdel{$r/r_{\rm eff}\sim 1$ }\DIFdelend \DIFaddbegin \DIFadd{$r/\reff \sim 1$ }\DIFaddend to find a plateau, which is
quite far from the limiting FA$=0.95$ suggesting that these voids are
\DIFdelbegin \DIFdel{far from spherical}\DIFdelend \DIFaddbegin \DIFadd{ellipsoidal}\DIFaddend . 

Put together, the results for the radially averaged profiles support the 
evidence for a universal density profile.  
Our results \DIFdelbegin \DIFdel{extends }\DIFdelend \DIFaddbegin \DIFadd{extend }\DIFaddend to smaller void sizes the work done by
...
{\DIFadd{Abazajian}} \DIFadd{K.,  et al.   }{\DIFadd{(the SDSS Collaboration)}} \DIFadd{2003, }\aj\DIFadd{, 126, 2081
}

\bibitem[\protect\citeauthoryear{{Alonso}, {Eardley} \& {Peacock}}{{Alonso}
  et~al.}{2015}]{Alonso2015}
{\DIFadd{Alonso}} \DIFadd{D.,  }{\DIFadd{Eardley}} \DIFadd{E.,    }{\DIFadd{Peacock}} \DIFadd{J.~A.,  2015, }\mnras\DIFadd{, 447, 2683
}

\bibitem[\protect\citeauthoryear{{Basser}}{{Basser}}{1995}]{Basser95}
{\DIFadd{Basser}} \DIFadd{P.,  1995, NMR in Biomedical Imaging, 8, 333
}

\bibitem[\protect\citeauthoryear{{Bertschinger}}{{Bertschinger}}{1985}]{Bertschinger85}
{\DIFadd{Bertschinger}} \DIFadd{E.,  1985, }\apjs\DIFadd{, 58, 1
}

\bibitem[\protect\citeauthoryear{{Beucher} \& {Lantuejoul}}{{Beucher} \&
  {Lantuejoul}}{1979}]{Beucher79}
{\DIFadd{Beucher}} \DIFadd{S.,  }{\DIFadd{Lantuejoul}} \DIFadd{C.,  1979, in Proceedings Interna- tional Workshop
  on Image Processing, CCETT/IRISA, Rennes, France
}

\bibitem[\protect\citeauthoryear{{Beucher} \& {Meyer}}{{Beucher} \&
  {Meyer}}{1993}]{Beucher93}
{\DIFadd{Beucher}} \DIFadd{S.,  }{\DIFadd{Meyer}} \DIFadd{F.,  1993, }{\DIFadd{Mathematical Morphology in Image
  Processing}}\DIFadd{.
...
{\DIFadd{Blumenthal}} \DIFadd{G.~R.,  }{\DIFadd{da Costa}} \DIFadd{L.~N.,  }{\DIFadd{Goldwirth}} \DIFadd{D.~S.,  }{\DIFadd{Lecar}} \DIFadd{M.,
  }{\DIFadd{Piran}} \DIFadd{T.,  1992, }\apj\DIFadd{, 388, 234
}

\bibitem[\protect\citeauthoryear{{Bond}, {Kofman} \& {Pogosyan}}{{Bond}
  et~al.}{1996}]{Bond96}
{\DIFadd{Bond}} \DIFadd{J.~R.,  }{\DIFadd{Kofman}} \DIFadd{L.,    }{\DIFadd{Pogosyan}} \DIFadd{D.,  1996, }\nat\DIFadd{, 380, 603
}

\bibitem[\protect\citeauthoryear{{Brunino}, {Trujillo}, {Pearce} \&
  {Thomas}}{{Brunino} et~al.}{2007}]{Brunino07}
{\DIFadd{Brunino}} \DIFadd{R.,  }{\DIFadd{Trujillo}} \DIFadd{I.,  }{\DIFadd{Pearce}} \DIFadd{F.~R.,    }{\DIFadd{Thomas}} \DIFadd{P.~A.,  2007,
  }\mnras\DIFadd{, 375, 184
}

\bibitem[\protect\citeauthoryear{{Ceccarelli}, {Padilla}, {Valotto} \&
  {Lambas}}{{Ceccarelli} et~al.}{2006}]{Ceccarelli06}
{\DIFadd{Ceccarelli}} \DIFadd{L.,  }{\DIFadd{Padilla}} \DIFadd{N.~D.,  }{\DIFadd{Valotto}} \DIFadd{C.,    }{\DIFadd{Lambas}} \DIFadd{D.~G.,  2006,
  }\mnras\DIFadd{, 373, 1440
}

\bibitem[\protect\citeauthoryear{{Ceccarelli}, {Paz}, {Lares}, {Padilla} \&
  {Lambas}}{{Ceccarelli} et~al.}{2013}]{Ceccarelli13}
{\DIFadd{Ceccarelli}} \DIFadd{L.,  }{\DIFadd{Paz}} \DIFadd{D.,  }{\DIFadd{Lares}} \DIFadd{M.,  }{\DIFadd{Padilla}} \DIFadd{N.,    }{\DIFadd{Lambas}} \DIFadd{D.~G.,
  2013, }\mnras\DIFadd{, 434, 1435
}

\bibitem[\protect\citeauthoryear{{Chincarini} \& {Rood}}{{Chincarini} \&
  {Rood}}{1975}]{Chincarini75}
{\DIFadd{Chincarini}} \DIFadd{G.,  }{\DIFadd{Rood}} \DIFadd{H.~J.,  1975, }\nat\DIFadd{, 257, 294
}

\bibitem[\protect\citeauthoryear{{Colberg}, {Pearce} \& et al.}{{Colberg}
  et~al.}{2008}]{Colberg08}
{\DIFadd{Colberg}} \DIFadd{J.~M.,  }{\DIFadd{Pearce}} \DIFadd{F.,    et al. 2008, }\mnras\DIFadd{, 387, 933
}

\bibitem[\protect\citeauthoryear{{Colberg}, {Sheth}, {Diaferio}, {Gao} \&
  {Yoshida}}{{Colberg} et~al.}{2005}]{Colberg05}
{\DIFadd{Colberg}} \DIFadd{J.~M.,  }{\DIFadd{Sheth}} \DIFadd{R.~K.,  }{\DIFadd{Diaferio}} \DIFadd{A.,  }{\DIFadd{Gao}} \DIFadd{L.,    }{\DIFadd{Yoshida}} \DIFadd{N.,
  2005, }\mnras\DIFadd{, 360, 216
}

\bibitem[\protect\citeauthoryear{{Colless}, et al. \& {(the 2dFGRS
  Team),}}{{Colless} et~al.}{2001}]{Colless01}
{\DIFadd{Colless}} \DIFadd{M.,  et al.   }{\DIFadd{(the 2dFGRS Team),}} \DIFadd{2001, }\mnras\DIFadd{, 328, 1039
}

\bibitem[\protect\citeauthoryear{{Colless}, et al. \& {(the 2dFGRS
  Team),}}{{Colless} et~al.}{2003}]{Colless03}
{\DIFadd{Colless}} \DIFadd{M.,  et al.   }{\DIFadd{(the 2dFGRS Team),}} \DIFadd{2003, VizieR Online Data Catalog,
  7226
}

\bibitem[\protect\citeauthoryear{{Croton} \& et al.}{{Croton} \&
  et~al.}{2004}]{Croton04}
{\DIFadd{Croton}} \DIFadd{D.~J.,  et al. 2004, }\mnras\DIFadd{, 352, 828
}

\bibitem[\protect\citeauthoryear{{Dubinski}, {da Costa}, {Goldwirth}, {Lecar}
  \& {Piran}}{{Dubinski} et~al.}{1993}]{Dubinski93}
{\DIFadd{Dubinski}} \DIFadd{J.,  }{\DIFadd{da Costa}} \DIFadd{L.~N.,  }{\DIFadd{Goldwirth}} \DIFadd{D.~S.,  }{\DIFadd{Lecar}} \DIFadd{M.,    }{\DIFadd{Piran}}
  \DIFadd{T.,  1993, }\apj\DIFadd{, 410, 458
}

\bibitem[\protect\citeauthoryear{{Einasto}, {Joeveer} \& {Saar}}{{Einasto}
  et~al.}{1980a}]{Einasto80M}
{\DIFadd{Einasto}} \DIFadd{J.,  }{\DIFadd{Joeveer}} \DIFadd{M.,    }{\DIFadd{Saar}} \DIFadd{E.,  1980a, }\mnras\DIFadd{, 193, 353
}

\bibitem[\protect\citeauthoryear{{Einasto}, {Joeveer} \& {Saar}}{{Einasto}
  et~al.}{1980b}]{Einasto80N}
{\DIFadd{Einasto}} \DIFadd{J.,  }{\DIFadd{Joeveer}} \DIFadd{M.,    }{\DIFadd{Saar}} \DIFadd{E.,  1980b, }\nat\DIFadd{, 283, 47
}

\bibitem[\protect\citeauthoryear{{Forero-Romero}, {Contreras} \&
  {Padilla}}{{Forero-Romero} et~al.}{2014}]{Forero2014}
{\DIFadd{Forero-Romero}} \DIFadd{J.~E.,  }{\DIFadd{Contreras}} \DIFadd{S.,    }{\DIFadd{Padilla}} \DIFadd{N.,  2014, }\mnras\DIFadd{, 443,
  1090
}

\bibitem[\protect\citeauthoryear{{Forero-Romero}, {Hoffman}, {Gottl{\"o}ber},
  {Klypin} \& {Yepes}}{{Forero-Romero} et~al.}{2009}]{Forero09}
{\DIFadd{Forero-Romero}} \DIFadd{J.~E.,  }{\DIFadd{Hoffman}} \DIFadd{Y.,  }{\DIFadd{Gottl}{\"o}\DIFadd{ber}} \DIFadd{S.,  }{\DIFadd{Klypin}} \DIFadd{A.,
  }{\DIFadd{Yepes}} \DIFadd{G.,  2009, }\mnras\DIFadd{, 396, 1815
}

\bibitem[\protect\citeauthoryear{{Foster} \& {Nelson}}{{Foster} \&
  {Nelson}}{2009}]{Foster09}
{\DIFadd{Foster}} \DIFadd{C.,  }{\DIFadd{Nelson}} \DIFadd{L.~A.,  2009, }\apj\DIFadd{, 699, 1252
}

\bibitem[\protect\citeauthoryear{{Gottl{\"o}ber}, {{\L}okas}, {Klypin} \&
  {Hoffman}}{{Gottl{\"o}ber} et~al.}{2003}]{Gottlober03}
{\DIFadd{Gottl}{\"o}\DIFadd{ber}} \DIFadd{S.,  }{{\DIFadd{\L}}\DIFadd{okas}} \DIFadd{E.~L.,  }{\DIFadd{Klypin}} \DIFadd{A.,    }{\DIFadd{Hoffman}} \DIFadd{Y.,  2003,
  }\mnras\DIFadd{, 344, 715
}

\bibitem[\protect\citeauthoryear{{Gregory} \& {Thompson}}{{Gregory} \&
  {Thompson}}{1978}]{Gregory78}
{\DIFadd{Gregory}} \DIFadd{S.~A.,  }{\DIFadd{Thompson}} \DIFadd{L.~A.,  1978, }\apj\DIFadd{, 222, 784
}

\bibitem[\protect\citeauthoryear{{Hahn}, {Porciani}, {Carollo} \&
  {Dekel}}{{Hahn} et~al.}{2007}]{Hahn07}
{\DIFadd{Hahn}} \DIFadd{O.,  }{\DIFadd{Porciani}} \DIFadd{C.,  }{\DIFadd{Carollo}} \DIFadd{C.~M.,    }{\DIFadd{Dekel}} \DIFadd{A.,  2007, }\mnras\DIFadd{, 375,
  489
}

\bibitem[\protect\citeauthoryear{{Hamaus}, {Sutter} \& {Wandelt}}{{Hamaus}
  et~al.}{2014}]{Hamaus14}
{\DIFadd{Hamaus}} \DIFadd{N.,  }{\DIFadd{Sutter}} \DIFadd{P.~M.,    }{\DIFadd{Wandelt}} \DIFadd{B.~D.,  2014, Physical Review
  Letters, 112, 251302
}

\bibitem[\protect\citeauthoryear{{Hinshaw} et~al.,}{{Hinshaw}
  et~al.}{2013}]{Hinshaw2013}
{\DIFadd{Hinshaw}} \DIFadd{G.  et~al., 2013, }\apjs\DIFadd{, 208, 19
}
...
{\DIFadd{Hoffman}} \DIFadd{Y.,  }{\DIFadd{Metuki}} \DIFadd{O.,  }{\DIFadd{Yepes}} \DIFadd{G.,  }{\DIFadd{Gottl}{\"o}\DIFadd{ber}} \DIFadd{S.,  }{\DIFadd{Forero-Romero}}
  \DIFadd{J.~E.,  }{\DIFadd{Libeskind}} \DIFadd{N.~I.,    }{\DIFadd{Knebe}} \DIFadd{A.,  2012, }\mnras\DIFadd{, 425, 2049
}

\bibitem[\protect\citeauthoryear{{Hoffman} \& {Shaham}}{{Hoffman} \&
  {Shaham}}{1982}]{Hoffman82}
{\DIFadd{Hoffman}} \DIFadd{Y.,  }{\DIFadd{Shaham}} \DIFadd{J.,  1982, }\apjl\DIFadd{, 262, L23
}

\bibitem[\protect\citeauthoryear{{Hoyle} \& {Vogeley}}{{Hoyle} \&
  {Vogeley}}{2004}]{Hoyle04}
{\DIFadd{Hoyle}} \DIFadd{F.,  }{\DIFadd{Vogeley}} \DIFadd{M.~S.,  2004, }\apj\DIFadd{, 607, 751
}

\bibitem[\protect\citeauthoryear{{Icke}}{{Icke}}{1984}]{Icke84}
{\DIFadd{Icke}} \DIFadd{V.,  1984, }\mnras\DIFadd{, 206, 1P
}

\bibitem[\protect\citeauthoryear{{Kauffmann} \& {Fairall}}{{Kauffmann} \&
  {Fairall}}{1991}]{Kauffmann91}
{\DIFadd{Kauffmann}} \DIFadd{G.,  }{\DIFadd{Fairall}} \DIFadd{A.~P.,  1991, }\mnras\DIFadd{, 248, 313
}

\bibitem[\protect\citeauthoryear{{Kirshner}, {Oemler} Jr., {Schechter} \&
  {Shectman}}{{Kirshner} et~al.}{1981}]{Kirshner81}
{\DIFadd{Kirshner}} \DIFadd{R.~P.,  }{\DIFadd{Oemler}} \DIFadd{Jr. A.,  }{\DIFadd{Schechter}} \DIFadd{P.~L.,    }{\DIFadd{Shectman}} \DIFadd{S.~A.,
  1981, }\apjl\DIFadd{, 248, L57
}

\bibitem[\protect\citeauthoryear{{Kirshner}, {Oemler} Jr., {Schechter} \&
  {Shectman}}{{Kirshner} et~al.}{1987}]{Kirshner87}
{\DIFadd{Kirshner}} \DIFadd{R.~P.,  }{\DIFadd{Oemler}} \DIFadd{Jr. A.,  }{\DIFadd{Schechter}} \DIFadd{P.~L.,    }{\DIFadd{Shectman}} \DIFadd{S.~A.,
  1987, }\apj\DIFadd{, 314, 493
}
...
{\DIFadd{Lavaux}} \DIFadd{G.,  }{\DIFadd{Wandelt}} \DIFadd{B.~D.,  2012, }\apj\DIFadd{, 754, 109
}
...
{\DIFadd{Libeskind}} \DIFadd{N.~I.,  }{\DIFadd{Hoffman}} \DIFadd{Y.,  }{\DIFadd{Forero-Romero}} \DIFadd{J.,  }{\DIFadd{Gottl}{\"o}\DIFadd{ber}} \DIFadd{S.,
  }{\DIFadd{Knebe}} \DIFadd{A.,  }{\DIFadd{Steinmetz}} \DIFadd{M.,    }{\DIFadd{Klypin}} \DIFadd{A.,  2013, }\mnras\DIFadd{, 428, 2489
}

\bibitem[\protect\citeauthoryear{{Martel} \& {Wasserman}}{{Martel} \&
  {Wasserman}}{1990}]{Martel90}
{\DIFadd{Martel}} \DIFadd{H.,  }{\DIFadd{Wasserman}} \DIFadd{I.,  1990, }\apj\DIFadd{, 348, 1
}

\bibitem[\protect\citeauthoryear{{Micheletti} et~al.,}{{Micheletti}
  et~al.}{2014}]{Micheletti14}
{\DIFadd{Micheletti}} \DIFadd{D.  et~al., 2014, }\aap\DIFadd{, 570, A106
}

\bibitem[\protect\citeauthoryear{{Mu{\~n}oz-Cuartas}, {M{\"u}ller} \&
  {Forero-Romero}}{{Mu{\~n}oz-Cuartas} et~al.}{2011}]{MunozCuartas11}
{\DIFadd{Mu}{\~n}\DIFadd{oz-Cuartas}} \DIFadd{J.~C.,  }{\DIFadd{M}{\"u}\DIFadd{ller}} \DIFadd{V.,    }{\DIFadd{Forero-Romero}} \DIFadd{J.~E.,  2011,
  }\mnras\DIFadd{, 417, 1303
}

\bibitem[\protect\citeauthoryear{{M{\"u}ller}, {Arbabi-Bidgoli}, {Einasto} \&
  {Tucker}}{{M{\"u}ller} et~al.}{2000}]{Muller00}
{\DIFadd{M}{\"u}\DIFadd{ller}} \DIFadd{V.,  }{\DIFadd{Arbabi-Bidgoli}} \DIFadd{S.,  }{\DIFadd{Einasto}} \DIFadd{J.,    }{\DIFadd{Tucker}} \DIFadd{D.,  2000,
  }\mnras\DIFadd{, 318, 280
}

\bibitem[\protect\citeauthoryear{{Nadathur} \& {Hotchkiss}}{{Nadathur} \&
  {Hotchkiss}}{2014}]{Nadathur14}
{\DIFadd{Nadathur}} \DIFadd{S.,  }{\DIFadd{Hotchkiss}} \DIFadd{S.,  2014, }\mnras\DIFadd{, 440, 1248
}

\bibitem[\protect\citeauthoryear{{Neyrinck}}{{Neyrinck}}{2008}]{Neyrinck08}
{\DIFadd{Neyrinck}} \DIFadd{M.~C.,  2008, }\mnras\DIFadd{, 386, 2101
}

\bibitem[\protect\citeauthoryear{{Neyrinck}, {Falck} \& {Szalay}}{{Neyrinck}
  et~al.}{2013}]{Neyrinck13}
{\DIFadd{Neyrinck}} \DIFadd{M.~C.,  }{\DIFadd{Falck}} \DIFadd{B.~L.,    }{\DIFadd{Szalay}} \DIFadd{A.~S.,  2013, ArXiv e-prints
}

\bibitem[\protect\citeauthoryear{{Padilla}, {Ceccarelli} \& {Lambas}}{{Padilla}
  et~al.}{2005}]{Padilla05}
{\DIFadd{Padilla}} \DIFadd{N.~D.,  }{\DIFadd{Ceccarelli}} \DIFadd{L.,    }{\DIFadd{Lambas}} \DIFadd{D.~G.,  2005, }\mnras\DIFadd{, 363, 977
}

\bibitem[\protect\citeauthoryear{{Pan}, {Vogeley}, {Hoyle}, {Choi} \&
  {Park}}{{Pan} et~al.}{2012}]{Pan10}
{\DIFadd{Pan}} \DIFadd{D.~C.,  }{\DIFadd{Vogeley}} \DIFadd{M.~S.,  }{\DIFadd{Hoyle}} \DIFadd{F.,  }{\DIFadd{Choi}} \DIFadd{Y.-Y.,    }{\DIFadd{Park}} \DIFadd{C.,  2012,
  }\mnras\DIFadd{, 421, 926
}

\bibitem[\protect\citeauthoryear{{Patiri}, {Betancort-Rijo} \&
  {Prada}}{{Patiri} et~al.}{2006}]{Patiri06a}
{\DIFadd{Patiri}} \DIFadd{S.~G.,  }{\DIFadd{Betancort-Rijo}} \DIFadd{J.,    }{\DIFadd{Prada}} \DIFadd{F.,  2006, }\mnras\DIFadd{, 368, 1132
}

\bibitem[\protect\citeauthoryear{{Patiri}, {Prada}, {Holtzman}, {Klypin} \&
  {Betancort-Rijo}}{{Patiri} et~al.}{2006}]{Patiri06b}
{\DIFadd{Patiri}} \DIFadd{S.~G.,  }{\DIFadd{Prada}} \DIFadd{F.,  }{\DIFadd{Holtzman}} \DIFadd{J.,  }{\DIFadd{Klypin}} \DIFadd{A.,    }{\DIFadd{Betancort-Rijo}}
  \DIFadd{J.,  2006, }\mnras\DIFadd{, 372, 1710
}

\bibitem[\protect\citeauthoryear{{Paz}, {Lares}, {Ceccarelli}, {Padilla} \&
  {Lambas}}{{Paz} et~al.}{2013}]{Paz13}
{\DIFadd{Paz}} \DIFadd{D.,  }{\DIFadd{Lares}} \DIFadd{M.,  }{\DIFadd{Ceccarelli}} \DIFadd{L.,  }{\DIFadd{Padilla}} \DIFadd{N.,    }{\DIFadd{Lambas}} \DIFadd{D.~G.,
  2013, }\mnras\DIFadd{, 436, 3480
}

\bibitem[\protect\citeauthoryear{{Platen}, {van de Weygaert} \&
  {Jones}}{{Platen} et~al.}{2007}]{Platen07}
{\DIFadd{Platen}} \DIFadd{E.,  }{\DIFadd{van de Weygaert}} \DIFadd{R.,    }{\DIFadd{Jones}} \DIFadd{B.~J.~T.,  2007, }\mnras\DIFadd{, 380,
  551
}

\bibitem[\protect\citeauthoryear{{Plionis} \& {Basilakos}}{{Plionis} \&
  {Basilakos}}{2002}]{Plionis02}
{\DIFadd{Plionis}} \DIFadd{M.,  }{\DIFadd{Basilakos}} \DIFadd{S.,  2002, }\mnras\DIFadd{, 330, 399
}

\bibitem[\protect\citeauthoryear{{Regos} \& {Geller}}{{Regos} \&
  {Geller}}{1991}]{Regos91}
{\DIFadd{Regos}} \DIFadd{E.,  }{\DIFadd{Geller}} \DIFadd{M.~J.,  1991, }\apj\DIFadd{, 377, 14
}

\bibitem[\protect\citeauthoryear{{Ricciardelli}, {Quilis} \&
  {Planelles}}{{Ricciardelli} et~al.}{2013}]{Ricciardelli2013}
{\DIFadd{Ricciardelli}} \DIFadd{E.,  }{\DIFadd{Quilis}} \DIFadd{V.,    }{\DIFadd{Planelles}} \DIFadd{S.,  2013, }\mnras\DIFadd{, 434, 1192
}

\bibitem[\protect\citeauthoryear{{Riebe} et~al.,}{{Riebe}
  et~al.}{2013}]{Riebe11}
{\DIFadd{Riebe}} \DIFadd{K.  et~al., 2013, Astronomische Nachrichten, 334, 691
}

\bibitem[\protect\citeauthoryear{{Rojas}, {Vogeley}, {Hoyle} \&
  {Brinkmann}}{{Rojas} et~al.}{2005}]{Rojas05}
{\DIFadd{Rojas}} \DIFadd{R.~R.,  }{\DIFadd{Vogeley}} \DIFadd{M.~S.,  }{\DIFadd{Hoyle}} \DIFadd{F.,    }{\DIFadd{Brinkmann}} \DIFadd{J.,  2005, }\apj\DIFadd{,
  624, 571
}

\bibitem[\protect\citeauthoryear{{Schaap} \& {van de Weygaert}}{{Schaap} \&
  {van de Weygaert}}{2000}]{Schaap00}
{\DIFadd{Schaap}} \DIFadd{W.~E.,  }{\DIFadd{van de Weygaert}} \DIFadd{R.,  2000, }\aap\DIFadd{, 363, L29
}

\bibitem[\protect\citeauthoryear{{Shandarin}, {Feldman}, {Heitmann} \&
  {Habib}}{{Shandarin} et~al.}{2006}]{Shandarin06}
{\DIFadd{Shandarin}} \DIFadd{S.,  }{\DIFadd{Feldman}} \DIFadd{H.~A.,  }{\DIFadd{Heitmann}} \DIFadd{K.,    }{\DIFadd{Habib}} \DIFadd{S.,  2006, }\mnras\DIFadd{,
  367, 1629
}

\bibitem[\protect\citeauthoryear{{Sheth} \& {van de Weygaert}}{{Sheth} \& {van
  de Weygaert}}{2004}]{Sheth04}
{\DIFadd{Sheth}} \DIFadd{R.~K.,  }{\DIFadd{van de Weygaert}} \DIFadd{R.,  2004, }\mnras\DIFadd{, 350, 517
}

\bibitem[\protect\citeauthoryear{{Sutter} et~al.,}{{Sutter}
  et~al.}{2015}]{Sutter14}
{\DIFadd{Sutter}} \DIFadd{P.~M.  et~al., 2015, Astronomy and Computing, 9, 1
}

\bibitem[\protect\citeauthoryear{{Sutter}, {Lavaux}, {Wandelt} \&
  {Weinberg}}{{Sutter} et~al.}{2012}]{Sutter12b}
{\DIFadd{Sutter}} \DIFadd{P.~M.,  }{\DIFadd{Lavaux}} \DIFadd{G.,  }{\DIFadd{Wandelt}} \DIFadd{B.~D.,    }{\DIFadd{Weinberg}} \DIFadd{D.~H.,  2012,
  }\apj\DIFadd{, 761, 44
}

\bibitem[\protect\citeauthoryear{{Sutter}, {Lavaux}, {Wandelt}, {Weinberg} \&
  {Warren}}{{Sutter} et~al.}{2014}]{Sutter14a}
{\DIFadd{Sutter}} \DIFadd{P.~M.,  }{\DIFadd{Lavaux}} \DIFadd{G.,  }{\DIFadd{Wandelt}} \DIFadd{B.~D.,  }{\DIFadd{Weinberg}} \DIFadd{D.~H.,    }{\DIFadd{Warren}}
  \DIFadd{M.~S.,  2014, }\mnras\DIFadd{, 438, 3177
}

\bibitem[\protect\citeauthoryear{{Tikhonov}}{{Tikhonov}}{2006}]{Tikhonov06}
{\DIFadd{Tikhonov}} \DIFadd{A.~V.,  2006, Astronomy Letters, 32, 727
}

\bibitem[\protect\citeauthoryear{{Tikhonov}}{{Tikhonov}}{2007}]{Tikhonov07}
{\DIFadd{Tikhonov}} \DIFadd{A.~V.,  2007, Astronomy Letters, 33, 499
}

\bibitem[\protect\citeauthoryear{{van de Weygaert} \& {van Kampen}}{{van de
  Weygaert} \& {van Kampen}}{1993}]{Weygaert93}
{\DIFadd{van de Weygaert}} \DIFadd{R.,  }{\DIFadd{van Kampen}} \DIFadd{E.,  1993, }\mnras\DIFadd{, 263, 481
}

\bibitem[\protect\citeauthoryear{{von Benda-Beckmann} \& {M{\"u}ller}}{{von
  Benda-Beckmann} \& {M{\"u}ller}}{2008}]{BendaBeckmann08}
{\DIFadd{von Benda-Beckmann}} \DIFadd{A.~M.,  }{\DIFadd{M}{\"u}\DIFadd{ller}} \DIFadd{V.,  2008, }\mnras\DIFadd{, 384, 1189
}

\bibitem[\protect\citeauthoryear{{York}, et al. \& {(the SDSS
  Collaboration),}}{{York} et~al.}{2000}]{York00}
{\DIFadd{York}} \DIFadd{D.~G.,  et al.   }{\DIFadd{(the SDSS Collaboration),}} \DIFadd{2000, }\aj\DIFadd{, 120, 1579
}

\bibitem[\protect\citeauthoryear{{Zeldovich}, {Einasto} \&
  {Shandarin}}{{Zeldovich} et~al.}{1982}]{Zeldovich82}
{\DIFadd{Zeldovich}} \DIFadd{I.~B.,  }{\DIFadd{Einasto}} \DIFadd{J.,    }{\DIFadd{Shandarin}} \DIFadd{S.~F.,  1982, }\nat\DIFadd{, 300, 407
}

\bibitem[\protect\citeauthoryear{{Zel'dovich}}{{Zel'dovich}}{1970}]{Zeldovich70}
{\DIFadd{Zel'dovich}} \DIFadd{Y.~B.,  1970, }\aap\DIFadd{, 5, 84
}
