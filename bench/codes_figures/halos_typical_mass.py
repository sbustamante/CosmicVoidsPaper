#halos_typical_mass.py
#
#This code plots typical values (median and Q1 and Q3 quartiles) of dark matter mass in each type of
#environment according to Lambda_thr values
...
quartiles[:,1:] = np.log10(quartiles[:,1:]/1.0e12)
...
if sys.argv[3] == '1':
    plt.savefig( '%shalos_typical_mass_%s_%s.pdf'%(figures_fold, catalogue, web) )
else:
    plt.show()